...
public class IgnitionSocket
{
    ...
    public void Write( string input, PacketType packetType = PacketType.None ) => Write( Encoding.UTF8.GetBytes( input ), packetType );

    public void Write( byte[] data, PacketType packetType = PacketType.None )
    {
    ...
    public PacketMetadata Read()
    {
        ...
        PacketType packetType = ( PacketType )BitConverter.ToInt32( typeBuffer );
